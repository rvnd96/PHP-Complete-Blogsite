...
if(isset($_POST['Submit'])) {
    ...
    /*if(empty($Title)) {
    ...
    } */ /*getting the DB connection and insert into the database*/
        global $Connection;
        ...
        if ($Execute) {
            ...
            $_SESSION["ErrorMessage"] = "Something went wrong. Post not deleted. Try again.";
            Redirect_to("dashboard.php");
        }
}
?>
    ...
    <body>
        ...
        <div class="container-fluid">
        	<div class="row">
        		...
        		<div class="col-md-9 col-xl-10 mainBar"> <!-- Main Bar -->
        			<h1>Delete Post</h1>
                        ...
                        <form action="deletePost.php?Delete=<?php echo $SearchQueryParameter; ?>" method="POST" enctype="multipart/form-data">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <input disabled="disabled" value="<?php echo $TitleToBeUpdated; ?>" class="form-control" type="text" name="Title" id="title" placeholder="Title">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea disabled  name="Post" id="postarea" class="form-control"><?php echo $PostToBeUpdated; ?></textarea>
                                </div>
